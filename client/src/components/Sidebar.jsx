...
function Sidebar() {
  return (
    <div className="home-sidebar">
          <ul id="list-side" className="list-group">
              <li className="list-group-item">
                  <small className="Title" >MAIN MENU</small>
              </li>
              <li className="sidebar-separator "><hr className="separator"/></li>  
              ...
              <Link to="/home" className="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                    <div className="d-flex">
                        ...
                        <span id="collapse-text" className="menu-collapsed">Home</span>
                    </div>
              </Link>
            ...
            <a href="#" className="bg-dark list-group-item list-group-item-action flex-column align-items-start">
              <div className="d-flex">
                      ...
                      <span id="collapse-text" className="menu-collapsed">Profile</span>
            ...
            <Link to='/create-post' className="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                  <div className="d-flex">
                    ...
                    <span id="collapse-text"  className="menu-collapsed">Crear</span>    
                  </div>
            </Link>

            <li className="list-group-item sidebar-separator "><hr className="separator" /></li>  
            <a href="#" className="bg-dark list-group-item list-group-item-action flex-column align-items-start">
              <div className="d-flex">
              <span id="collapse-icon" className="fa fa-question fa-fw mr-3"></span>
              <span id="collapse-text"  className="menu-collapsed">Help</span>
              </div>
            </a>
        ...
        <li className="sidebar-separator "><hr className="separator"/></li>  
        <Link to="/profile">
              <div id="d-flex-two" className="d-flex">
                <span id="collapse-icon" className="fa fa-user fa-fw mr-3"></span>
                              <span id="collapse-text" className="menu-collapsed">Perfil</span>
                              <span className="submenu-icon ml-auto"></span>
              </div>
        </Link>
